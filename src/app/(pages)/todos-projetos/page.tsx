...
export default function TodosProjetos() {
  ...
  // UseEffect para usar a função de pegar os projetos do firebase
  useEffect(() => {
    async function fetchAllProjects() {
      ...
      querySnapshot.forEach((result) => {
        ...
        const processedData: ProjectProps = {
          id: result.id,
          name: rawData.nomeProjeto,
          status: "aprovado",
          value: rawData.valorApto,
          incentiveLaw: rawData.lei,
          description: rawData.descricao,
          ODS: processedODS,
        };
        projects.push(processedData);
  ...
  function situationFilters(situacao: string) {
    setFilters((prevFilters) => ({
      ...
      status: prevFilters.status.map((item) =>
        item.situation === situacao ? { ...item, state: !item.state } : item
      ),
    }));
  }
  ...
  function ODSFilters(number: number) {
    setFilters((prevFilters) => ({
      ...
      ODS: prevFilters.ODS.map((item) =>
        item.numberODS === number ? { ...item, state: !item.state } : item
      ),
    }));
  }
  ...
  function applyFilters() {
    ...
    const activeLaws = filters.incentiveLaw
      .filter((f) => f.state)
      .map((f) => f.law);
    const activeODS = filters.ODS.filter((f) => f.state).map(
      (f) => f.numberODS
    );
      ...
      const matchValue =
        ...
        activeValues.some(
          (range) =>
            ...
            (range.finalValue === undefined ||
              project.value <= range.finalValue)
        );
          ...
          <div className="flex flex-row gap-x-4 mt-3">
            ...
            >
              ...
              {isOpen && (
                ...
                <div
                  ref={caixaRef}
                  className="absolute top-full left-0 w-[90vw] md:w-[700px] lg:w-[768px] xl:w-[768px]  bg-white dark:bg-blue-fcsn2 p-2 pl-4 rounded shadow-md z-10"
                >
                  <p className="text-2xl text-blue-fcsn dark:text-white-off font-bold">
                    Filtros
                  </p>
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.status.find((f) => f.situation === "aprovado")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.status.find((f) => f.situation === "pendente")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.status.find((f) => f.situation === "reprovado")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      checked={
                        filters.value.find(
                          (f) => f.initialValue === 0 && f.finalValue === 1000
                        )?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      checked={
                        filters.value.find(
                          (f) =>
                            f.initialValue === 100000.01 &&
                            f.finalValue === 1000000
                        )?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      checked={
                        filters.value.find(
                          (f) =>
                            f.initialValue === 1000000.01 &&
                            f.finalValue === undefined
                        )?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "CULTURA")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "PROAC")
                          ?.state || false
                      }
                      className="w-5 h-5 text-blue-fcsn rounded border-gray-300"
                    />
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "FIA")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "LIE")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "IDOSO")
                          ?.state || false
                      }
                      className="w-5 h-5 text-blue-fcsn rounded border-gray-300"
                    />
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "PRONAS")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "PRONON")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "PROMAC")
                          ?.state || false
                      }
                    ...
                    />
                    <span>
                      Promac – Programa de Incentivo à Cultura do Município de
                      São Paulo
                    </span>
                  </label>
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "ICMS-MG")
                          ?.state || false
                      }
                      className="w-5 h-5 text-blue-fcsn rounded border-gray-300"
                    />
                    <span>
                      ICMS – MG Imposto sobre Circulação de Mercadoria e
                      Serviços
                    </span>
                  </label>
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "ICMS-RJ")
                          ?.state || false
                      }
                    ...
                    />
                    <span>
                      ICMS – RJ Imposto sobre Circulação de Mercadoria e
                      Serviços
                    </span>
                  </label>
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.incentiveLaw.find((f) => f.law === "PIE")
                          ?.state || false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 1)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 2)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 3)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 4)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 5)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 6)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 7)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 8)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 9)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 10)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 11)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 12)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 13)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 14)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 15)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 16)?.state ||
                        false
                      }
                  ...
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={
                        filters.ODS.find((f) => f.numberODS === 17)?.state ||
                        false
                      }
                  ...
                  <button
                    className="bg-blue-fcsn dark:bg-blue-fcsn3 rounded-lg p-2 text-white mt-8 mb-3 ml-2 cursor-pointer"
                    onClick={() => applyFilters()}
                  >
                    Aplicar filtros
                  </button>
                  <button
                    className="bg-blue-fcsn dark:bg-blue-fcsn3 rounded-lg p-2 text-white mt-8 ml-4 mb-3 cursor-pointer"
          ...
          */}
          {search ? (
            resSearch.length > 0 ? (
              ...
              <p className="text-blue-fcsn dark:text-white-off text-xl">
            ...
            filteredProjects.length > 0 ? (
              ...
              <p className="text-blue-fcsn dark:text-white-off text-xl">
                Nenhum projeto encontrado com esse(s) filtro(s).
              </p>
            )
          ) : (
