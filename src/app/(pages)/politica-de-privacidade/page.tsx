...
export default function privacy_policy(){
    ...
    return(
        <div className="flex flex-col justify-between items-center w-screen h-auto bg-white-off">
            <Header></Header>
            <h1 className="text-blue-fcsn text-4xl font-bold">POLÍTICA DE PRIVACIDADE DE DADOS EXTERNA</h1>
